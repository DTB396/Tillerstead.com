...
<div class="page">
  ...
  const saveToStorage = debounce(function() {
    try {
      ...
      // // // console.warn('Could not save to localStorage:', e); // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED
    }
  }, 500);
  ...
  function loadFromStorage() {
    try {
      ...
      // // // console.warn('Could not load from localStorage:', e); // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED
    }
    return false;
  }
  ...
  function autoCalculate(calculatorType, card) {
    ...
    try {
      ...
      // // // console.warn('Auto-calculate error:', e); // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED
    }
  ...
  function init() {
    ...
    if (typeof window !== 'undefined') {
      ...
      // // // console.log('Tillerstead Tools loaded. Access via window.TillersteadTools'); // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED
    }
  }
