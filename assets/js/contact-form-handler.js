...
(function () {
  ...
  async function submitToNetlify(formData) {
    ...
    try {
      ...
      // // // console.warn('Netlify Forms failed, trying mailto fallback:', e); // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED
    }
...
Submitted: ${new Date().toLocaleString()}
    ...
    try {
      ...
      // // // console.warn('Formspree failed:', e); // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED
    }
