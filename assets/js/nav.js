...
(() => {
  ...
  // // // // // // // console.log('[DEBUG] Adding aria and mobile view logging'); // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED

  const syncAria = (open) => {
    const state = open ? 'true' : 'false';
    // // // // // // // console.log(`[DEBUG] syncAria called with state: ${state}`); // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED
    // // // // // // // console.log('[DEBUG] navToggle:', navToggle); // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED
    // // // // // // // console.log('[DEBUG] nav:', nav); // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED
    // // // // // // // console.log('[DEBUG] navShell:', navShell); // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED
    // // // // // // // console.log('[DEBUG] navOverlay:', navOverlay); // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED
  ...
  const openNav = () => {
    // // // // // // // console.log('[TEST] openNav called', { navShell, nav, navOverlay }); // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED
  ...
  // // // // // // // console.log('[DEBUG] Attaching event listeners'); // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED

  // Mobile nav toggle
  if (navToggle) {
    // // // // // // // console.log('[DEBUG] navToggle event listener attached'); // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED
  ...
  // Close button
  if (navClose) {
    // // // // // // // console.log('[DEBUG] navClose event listener attached'); // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED
  ...
  // Overlay click
  if (navOverlay) {
    // // // // // // // console.log('[DEBUG] navOverlay event listeners attached'); // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED
  ...
  if (nav) {
    // // // // // // // console.log('[DEBUG] nav link click listener attached'); // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED
  ...
  try {
    ...
    if (window?.console?.warn) {
      // // // // // // // console.warn('Navigation initialization error:', err); // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED
    }
  }
